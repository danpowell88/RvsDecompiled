...
def classify(b):
    """Detailed classification of function body."""
    if b[0] == 0xC3:
...
# Check Core.dll for UnObj void stubs
targets = [
    'ProcessDelegate', 'ProcessState', 'Modify', 'ShutdownAfterError',
    'PostEditChange', 'Register', 'LanguageChange', 'StaticTick',
    'BindPackage', 'ResetLoaders', 'VerifyLinker', 'GetRegistryObjects',
    'ScriptConsoleExec', 'StaticExec',
    # Also check integer returns
    'GotoLabel', 'IsInState', 'IsReferenced', 'AttemptDelete',
    # UnExport
    'StaticConstructor',
    # UnClass  
    'AddCppProperty', 'Bind',
...
print("=== Core.dll void/return stubs from UnObj.cpp etc ===")
