"""Find smallest IMPL_TODO functions for priority implementation."""
    ...
    try:
        ...
        for i, line in enumerate(lines):
            if 'IMPL_TODO' in line:
                ...
                am = re.search(r'0x([0-9a-fA-F]{8,})', context)
                if am:
...
print()
print('Smallest 30 IMPL_TODO functions:')
for t in sized_todos[:30]:
    print('  %4dB  %s:%d  %s' % (t['size'], t['file'], t['line'], t['func'][:60]))
