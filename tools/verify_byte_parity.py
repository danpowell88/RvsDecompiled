...
DLL_MAP = {
    ...
    "dareaudio":    {"retail": "DareAudio.dll",     "built": "DareAudio.dll",
                     ...
                     "base":   0x10000000},
    "dareaudiorelease":{"retail": "DareAudioRelease.dll", "built": "DareAudioRelease.dll",
                     "ghidra": "DareAudioRelease/_global.cpp",
                     "base":   0x10000000},
    "dareaudioscript":{"retail": "DareAudioScript.dll", "built": "DareAudioScript.dll",
                     "ghidra": "DareAudioScript/_global.cpp",
                     "base":   0x10000000},
