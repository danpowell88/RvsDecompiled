...
IMPL_MATCH("R6Engine.dll", 0x10039970)
...
IMPL_MATCH("R6Engine.dll", 0x10039b00)
...
IMPL_MATCH("R6Engine.dll", 0x100396f0)
...
IMPL_MATCH("R6Engine.dll", 0x10039490)
...
IMPL_MATCH("R6Engine.dll", 0x10038850)
...
IMPL_MATCH("R6Engine.dll", 0x1003a080)
...
IMPL_MATCH("R6Engine.dll", 0x1003a2c0)
...
IMPL_MATCH("R6Engine.dll", 0x1003a120)
...
IMPL_MATCH("R6Engine.dll", 0x10039e40)
...
IMPL_MATCH("R6Engine.dll", 0x10039d90)
...
IMPL_MATCH("R6Engine.dll", 0x10039ce0)
...
IMPL_MATCH("R6Engine.dll", 0x10039c30)
...
IMPL_MATCH("R6Engine.dll", 0x10039620)
...
IMPL_MATCH("R6Engine.dll", 0x10039f50)
...
IMPL_MATCH("R6Engine.dll", 0x10037840)
FVector AR6RainbowAI::getEntryPosition()
{
	return FVector(0,0,0);
}

IMPL_MATCH("R6Engine.dll", 0x10038450)
FVector AR6RainbowAI::getGuardPosition()
{
	return FVector(0,0,0);
}

IMPL_MATCH("R6Engine.dll", 0x10038660)
FVector AR6RainbowAI::getLadderPosition()
{
	return FVector(0,0,0);
}

IMPL_MATCH("R6Engine.dll", 0x10036d00)
FVector AR6RainbowAI::getPreEntryPosition()
{
	return FVector(0,0,0);
}

IMPL_MATCH("R6Engine.dll", 0x10038b40)
FVector AR6RainbowAI::getTargetPosition()
{
	return FVector(0,0,0);
}

IMPL_MATCH("R6Engine.dll", 0x10035b50)
...
IMPL_MATCH("R6Engine.dll", 0x10035e90)
...
IMPL_MATCH("R6Engine.dll", 0x10035c10)
