...
IMPL_INFERRED("Safely destroys associated stair volume actor on script cleanup")
...
IMPL_INFERRED("Associates this orientation marker with its parent stair volume")
