...
IMPL_INFERRED("Reconstructed with divergence: retail error-log args in data sections; generic message used")
...
IMPL_INFERRED("Reconstructed editor validation for missing climb height")
...
IMPL_INFERRED("Reconstructed actor destruction of spawned climbable point markers")
...
IMPL_INFERRED("Reconstructed trace flag filter: always visible to level geometry traces")
