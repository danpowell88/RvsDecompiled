...
IMPL_DIVERGE("FUN_10042934 (0x10042934): x87 ftol2 reads FPU ST0 register; not recoverable from Ghidra decompilation; bone rotation cached value approximated as 0")
