//=============================================================================
// R6DescAssaultType97 - extracted from retail RavenShield 1.60
...
defaultproperties
{
	...
	m_2dMenuRegion=(Zone=Class'R6Description.R6SecondaryWeaponDescription',iLeaf=98594,ZoneNumber=0)
