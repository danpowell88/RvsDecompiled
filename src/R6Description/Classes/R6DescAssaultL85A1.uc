//=============================================================================
// R6DescAssaultL85A1 - extracted from retail RavenShield 1.60
...
defaultproperties
{
	...
	m_2dMenuRegion=(Zone=Class'R6Description.R6SecondaryWeaponDescription',iLeaf=59170,ZoneNumber=0)
