...
function RefreshLocation()
{
	...
	{
		SetLocation(((OwnerPoint.Location + OwnerPoint.prevActionPoint.Location) * 0.5000000));
		m_iPlanningFloor_0 = Owner.m_iPlanningFloor_0;
		m_iPlanningFloor_1 = OwnerPoint.prevActionPoint.m_iPlanningFloor_0;		
	}
	else
	{
		fEvenCheck = (float(OwnerPoint.prevActionPoint.m_PathToNextPoint.Length) % float(2));
		// End:0x43F
		if((fEvenCheck == float(0)))
		{
			...
			SetLocation(((vFirstVector + vSecondVector) * 0.5000000));
			// End:0x37A
