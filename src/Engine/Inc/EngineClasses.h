...
enum ER6SwitchSurface { R6SS_Default=0, R6SS_Offscreen=1 };
...
public:
	...
	// Retail: 9 params (mangled ...HHHHH@Z); no fStepDist.
...
// Enum types from TexModifier.uc (UTexCoordMaterial = TexModifier)
enum ETexCoordSrc
{
	TCS_Stream0=0, TCS_Stream1=1, TCS_Stream2=2, TCS_Stream3=3,
	TCS_Stream4=4, TCS_Stream5=5, TCS_Stream6=6, TCS_Stream7=7,
	TCS_WorldCoords=8, TCS_CameraCoords=9,
	TCS_WorldEnvMapCoords=10, TCS_CameraEnvMapCoords=11,
	TCS_ProjectorCoords=12, TCS_NoChange=13
};
