...
function AddModSpecificGameModes(LevelInfo pLevelInfo)
{
	...
	pLevelInfo.GameTypeSaveGameInfo((pLevelInfo.m_aGameTypeInfo.Length - 1), Localize("SaveGameDirectory", "SaveGameType_Mission", "R6Engine"), "Mission");
	...
	pLevelInfo.GameTypeSaveGameInfo((pLevelInfo.m_aGameTypeInfo.Length - 1), Localize("SaveGameDirectory", "SaveGameType_TerroristHunt", "R6Engine"), "Terrorist Hunt");
	...
	pLevelInfo.GameTypeSaveGameInfo((pLevelInfo.m_aGameTypeInfo.Length - 1), Localize("SaveGameDirectory", "SaveGameType_HostageRescue", "R6Engine"), "Hostage Rescue");
	...
	pLevelInfo.GameTypeSaveGameInfo((pLevelInfo.m_aGameTypeInfo.Length - 1), Localize("SaveGameDirectory", "SaveGameType_LoneWolf", "R6Engine"), "Lone Wolf");
