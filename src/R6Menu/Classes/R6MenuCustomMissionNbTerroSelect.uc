...
function Created()
{
	...
	m_TerroCounter = R6WindowCounter(CreateWindow(Class'R6Window.R6WindowCounter', 0.0000000, ((m_TitleNbTerro.WinTop + m_TitleNbTerro.WinHeight) + float(9)), WinWidth, 15.0000000, self));
	...
	m_TerroCounter.CreateButtons(((m_TerroCounter.WinWidth / float(2)) - float(30)), 0.0000000, 60.0000000);
...
function Paint(Canvas C, float X, float Y)
{
	...
	DrawStretchedTexture(C, 0.0000000, (m_TitleNbTerro.WinTop + m_TitleNbTerro.WinHeight), WinWidth, 1.0000000, Texture'UWindow.WhiteTexture');
	return;
}
