...
function Created()
{
	...
	m_TextPreRecMessages[0] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', float(__NFUN_146__(m_RRecMsg.X, 5)), float(__NFUN_146__(m_RRecMsg.Y, 30)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextPreRecMessages[0].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM1", "R6RecMessages"), " "), Localize("RecMessages", "ID_MSG1", "R6RecMessages"));
	...
	m_TextPreRecMessages[1] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', float(__NFUN_146__(m_RRecMsg.X, 5)), float(__NFUN_146__(m_RRecMsg.Y, 50)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextPreRecMessages[1].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM2", "R6RecMessages"), " "), Localize("RecMessages", "ID_MSG2", "R6RecMessages"));
	...
	m_TextPreRecMessages[2] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', float(__NFUN_146__(m_RRecMsg.X, 5)), float(__NFUN_146__(m_RRecMsg.Y, 70)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextPreRecMessages[2].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM3", "R6RecMessages"), " "), Localize("RecMessages", "ID_MSG3", "R6RecMessages"));
	...
	m_TextPreRecMessages[3] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', float(__NFUN_146__(m_RRecMsg.X, 5)), float(__NFUN_146__(m_RRecMsg.Y, 90)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextPreRecMessages[3].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM4", "R6RecMessages"), " "), Localize("RecMessages", "ID_MSG4", "R6RecMessages"));
	...
	m_TextPreRecMessages[4] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', float(__NFUN_146__(m_RRecMsg.X, 5)), float(__NFUN_146__(m_RRecMsg.Y, 110)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextPreRecMessages[4].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM0", "R6RecMessages"), " "), Localize("ExitMenu", "ID_MSG0", "R6RecMessages"));
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	if(__NFUN_129__(m_bFirstTimePaint))
	{
		...
		// End:0x8C
		if(__NFUN_177__(fWidth, __NFUN_175__(float(m_RRecMsg.W), m_fOffsetTxtPos)))
		{
			m_RRecMsg.W = int(__NFUN_174__(fWidth, m_fOffsetTxtPos));
		}
		i = 0;
		J0x93:
