...
function Created()
{
	...
	m_TextDefensive[0] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 30)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[1] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 50)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[2] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 70)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[3] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 90)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[4] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 110)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[5] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 130)), (WinWidth - float(5)), 25.0000000, self));
	...
	m_TextDefensive[6] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float((m_RMsgSize.Y + 150)), (WinWidth - float(5)), 25.0000000, self));
