...
function Created()
{
	...
	m_TextOffensive[0] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 30)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[0].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM1", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG11", "R6RecMessages"));
	...
	m_TextOffensive[1] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 50)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[1].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM2", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG12", "R6RecMessages"));
	...
	m_TextOffensive[2] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 70)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[2].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM3", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG13", "R6RecMessages"));
	...
	m_TextOffensive[3] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 90)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[3].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM4", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG14", "R6RecMessages"));
	...
	m_TextOffensive[4] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 110)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[4].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM5", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG15", "R6RecMessages"));
	...
	m_TextOffensive[5] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 130)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[5].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM6", "R6RecMessages"), " "), Localize("Offensive", "ID_MSG16", "R6RecMessages"));
	...
	m_TextOffensive[6] = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 5.0000000, float(__NFUN_146__(m_RMsgSize.Y, 150)), __NFUN_175__(WinWidth, float(5)), 25.0000000, self));
	m_TextOffensive[6].Text = __NFUN_112__(__NFUN_112__(Localize("Number", "ID_NUM0", "R6RecMessages"), " "), Localize("ExitMenu", "ID_MSG0", "R6RecMessages"));
