...
function Created()
{
	...
	m_ButtonCustomMission = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonSinglePlayer.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_ButtonMultiPlayer = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonCustomMission.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_ButtonTraining = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonMultiPlayer.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_ButtonOption = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonTraining.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_ButtonCredits = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonOption.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_ButtonQuit = R6WindowButtonMainMenu(CreateWindow(Class'R6Menu.R6WindowButtonMainMenu', m_fButtonXpos, __NFUN_174__(m_ButtonCredits.WinTop, m_fButtonOffset), m_fButtonWidth, m_fButtonHeight, self));
	...
	m_Version = R6WindowTextLabel(CreateWindow(Class'R6Window.R6WindowTextLabel', 421.0000000, __NFUN_175__(WinHeight, float(18)), 200.0000000, 15.0000000, self));
	m_Version.SetProperties(Class'Engine.Actor'.static.__NFUN_1419__(true), 1, Root.Fonts[10], Root.Colors.White, false);
	return;
}
