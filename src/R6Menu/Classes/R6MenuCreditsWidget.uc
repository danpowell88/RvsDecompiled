//=============================================================================
// R6MenuCreditsWidget - extracted from retail RavenShield 1.60
...
function Created()
{
	m_ListOfCredits = R6MenuCredits(CreateWindow(Class'R6Menu.R6MenuCredits', float(m_RVideo.X), float(m_RVideo.Y), float(m_RVideo.W), float(m_RVideo.H), self));
...
function Paint(Canvas C, float X, float Y)
{
	...
	DrawStretchedTextureSegment(C, 0.0000000, 0.0000000, 512.0000000, float(m_RVideo.Y), 0.0000000, 0.0000000, 512.0000000, float(m_RVideo.Y), R6WRoot.m_BGTexture[0]);
	DrawStretchedTextureSegment(C, 512.0000000, 0.0000000, 512.0000000, float(m_RVideo.Y), 0.0000000, 0.0000000, 512.0000000, float(m_RVideo.Y), R6WRoot.m_BGTexture[1]);
	DrawStretchedTextureSegment(C, 0.0000000, float(m_RVideo.Y), float(m_ILeftVideoW), float(m_RVideo.H), 0.0000000, float(m_RVideo.Y), float(m_ILeftVideoW), float(m_RVideo.H), R6WRoot.m_BGTexture[0]);
	DrawStretchedTextureSegment(C, float(m_IRightVideoX), float(m_RVideo.Y), float(m_IRightVideoW), float(m_RVideo.H), float(m_IRightVideoTextX), float(m_RVideo.Y), float(m_IRightVideoW), float(m_RVideo.H), R6WRoot.m_BGTexture[1]);
	DrawStretchedTextureSegment(C, 0.0000000, float(m_IBottomVideoY), 512.0000000, float(m_IBottomVideoH), 0.0000000, float(m_IBottomVideoY), 512.0000000, float(m_IBottomVideoH), R6WRoot.m_BGTexture[0]);
	DrawStretchedTextureSegment(C, 512.0000000, float(m_IBottomVideoY), 512.0000000, float(m_IBottomVideoH), 0.0000000, float(m_IBottomVideoY), 512.0000000, float(m_IBottomVideoH), R6WRoot.m_BGTexture[1]);
	return;
}
...
defaultproperties
{
	...
	m_RVideo=(Zone=Class'R6Menu.R6MenuOperativeSkillsLabel',iLeaf=17954,ZoneNumber=0)
}
