//=============================================================================
// R6MenuLegendPageInteractive - extracted from retail RavenShield 1.60
...
function Created()
{
	...
	R6MenuLegendItem(m_ButtonItem[5]).m_pObjectIcon = Texture'R6Planning.Icons.PlanIcon_CamDirection';
