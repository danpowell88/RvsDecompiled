...
//temp2
	...
	virtual void ExportCpp( FOutputDevice& Out, UBOOL IsLocal, UBOOL IsParm, UBOOL IsStruct ) const;
	//virtual void ExportCppItem( FOutputDevice& Out ) const=0;
	virtual void ExportCppItem( FOutputDevice& Out ) const;
	virtual void ExportCppItem( FOutputDevice& Out, INT Indent ) const;
	...
	virtual void SerializeBin( FArchive& Ar, BYTE* Data ) const;
...
class CORE_API UByteProperty : public UProperty
{
	...
	void ExportCppItem( FOutputDevice& Out, INT Indent ) const;
	...
	void CopySingleValue( void* Dest, void* Src, UObject* SuperObject ) const;
	void CopyCompleteValue( void* Dest, void* Src ) const;
	void CopyCompleteValue( void* Dest, void* Src, UObject* SuperObject ) const;
};
...
//
// Describes a delegate property (FName + UObject* pair for script delegates).
//
class CORE_API UDelegateProperty : public UProperty
{
	DECLARE_CLASS(UDelegateProperty,UProperty,0,Core)
