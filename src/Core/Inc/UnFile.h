...
// RVS fix: R6 Localize has a 6th param (extra UBOOL); default to 0 for UT99 compat.
CORE_API const TCHAR* Localize( const TCHAR* Section, const TCHAR* Key, const TCHAR* Package=GPackage, const TCHAR* LangExt=NULL, UBOOL Optional=0, UBOOL Optional2=0 );
...
#if UNICODE
	// RVS fix: R6 Localize has a 6th param (extra UBOOL); default to 0 for UT99 compat.
	CORE_API const TCHAR* Localize( const ANSICHAR* Section, const ANSICHAR* Key, const TCHAR* Package=GPackage, const TCHAR* LangExt=NULL, UBOOL Optional=0, UBOOL Optional2=0 );
