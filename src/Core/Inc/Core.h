...
public:
	...
	virtual void Init()=0;
	virtual void Exit()=0;
	// DIVERGENCE from SDK: declared non-inline; body in UnLog.cpp (Ghidra 0x10101c70).
...
public:
	...
	// DIVERGENCE from SDK: declared non-inline; bodies in UnLog.cpp (Ghidra 0x10101330/0x10101320).
	virtual void MapCheck_Add( INT Type, void* Actor, const TCHAR* Message );
