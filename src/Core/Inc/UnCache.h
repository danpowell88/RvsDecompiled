/*===============================================================================
	UnCache.h: Unreal fast memory cache support — Ravenshield override.
	Copyright 1997-1999 Epic Games, Inc. All Rights Reserved.

	Local shim: overrides SDK/432Core/Inc/UnCache.h to make GHash(DWORD)
	non-inline, allowing UnCache.cpp to provide the Ravenshield-specific
	hash formula (Ghidra 0x10102df0 — different from UT99).

	DIVERGENCE from SDK: GHash(DWORD) and GHash(QWORD) declared but not
	defined inline. Bodies are in UnCache.cpp.
===============================================================================*/

#ifndef _INC_UNCACHE_RVS
#define _INC_UNCACHE_RVS
...
public:
	...
	// DIVERGENCE from SDK: GHash declared but NOT defined inline.
	// Ravenshield uses a different hash formula than UT99.
	// Bodies are in UnCache.cpp (Ghidra 0x10102df0).
