...
IMPL_MATCH("R6GameService.dll", 0x1000a3b0)
...
IMPL_MATCH("R6GameService.dll", 0x10008730)
...
IMPL_MATCH("R6GameService.dll", 0x10007710)
...
IMPL_MATCH("R6GameService.dll", 0x100063a0)
...
IMPL_MATCH("R6GameService.dll", 0x10001320)
...
IMPL_MATCH("R6GameService.dll", 0x10009580)
...
IMPL_MATCH("R6GameService.dll", 0x10006210)
...
IMPL_MATCH("R6GameService.dll", 0x10005f20)
...
IMPL_MATCH("R6GameService.dll", 0x100063b0)
...
IMPL_MATCH("R6GameService.dll", 0x10005af0)
...
IMPL_MATCH("R6GameService.dll", 0x10005be0)
...
IMPL_MATCH("R6GameService.dll", 0x10008830)
...
IMPL_MATCH("R6GameService.dll", 0x100088d0)
...
IMPL_MATCH("R6GameService.dll", 0x100089d0)
